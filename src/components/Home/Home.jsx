...
const Home = () => {
    ...
    return (
        <>
            {loading ? (
                ...
                <div
                    className={`${mode === "dark" ? "text-lighter" : ""} ${
                        open && "blur-[7px]"
                    } relative pt-[100px] sm:pt-[60px] min-h-screen`}
                >
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-center px-3 md:p-6 2xl:px-[140px] 2xl:pr-[170px] gap-x-10 2xl:gap-x-[120px] sm:gap-y-[50px] min-h-screen">
                        ...
                        >
                            <Tilt className="">
                                <div
                                    className={`max-w-[350px] xl:max-w-[900px] min-w-[200px] sm:min-w-[400px] 2xl:min-w-[532px] lg:min-w-[450px] xl:min-w-[500px] 3xl:min-w-[600px] 3xl:min-h-[600px] rounded-[50px] overflow-hidden box `}
                                >
                                    <img
                                        src={mySelf}
                        ...
                        <div className="space-y-6 xl:space-y-5 flex flex-col items-center lg:items-start justify-center sm:px-[60px] md:px-0 mb-5">
                            ...
                            >
                                {text.split(" ").map((item, index) => (
                                    <motion.span
                                        variants={eachWord}
                                        className={`inline-block md:tracking-wide ${
                                            mode === "dark"
                                                ? "text-green-300"
                                                : "text-blue-950"
                                        } mr-2 md:mt-5 md:mr-4`}
                                        key={index}
                                    >
                                        {item}
                                    </motion.span>
                            ...
                            >
                                As a skilled frontend developer, I am dedicated
            ...
            {open && <div className=" fixed top-0 left-0 bottom-0 w-full" />}
