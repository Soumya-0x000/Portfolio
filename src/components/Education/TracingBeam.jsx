...
export const TracingBeam = ({ children }) => {
    ...
    useLayoutEffect(() => {
        const handleSVGheight = () => {
            contentRef.current &&
                setSvgHeight(contentRef.current.offsetHeight * 1.1);
        };
        handleSVGheight();
    ...
    const svgValue = [
        ...
        { pathValue: 0.31, gradientValue: 0.31 },
        { pathValue: 0.31, gradientValue: 0.314 },
        { pathValue: 0.518, gradientValue: 0.518 },
        { pathValue: 0.518, gradientValue: 0.522 },
        { pathValue: 0.57, gradientValue: 0.57 },
        { pathValue: 0.57, gradientValue: 0.574 },
        { pathValue: 0.754, gradientValue: 0.754 },
        { pathValue: 0.754, gradientValue: 0.758 },
        { pathValue: 0.8, gradientValue: 0.8 },
        { pathValue: 0.8, gradientValue: 0.804 },
        { pathValue: 0.976, gradientValue: 0.976 },
        { pathValue: 0.98, gradientValue: 0.98 },
    ];
                        ...
                        animate={{
                            backgroundColor:
                                scrollYProgress.get() > 0
                                    ...
                                    : "var(#10b981)",
                            borderColor:
                                scrollYProgress.get() > 0 ? "violet" : "violet",
                        }}
                    ...
                    <defs>
                        ...
                        >
                            ...
                            <stop
                                offset="0.325"
                                stopColor={
                                    mode === "dark" ? "#6344F5" : "#856BFF"
                                }
                            ></stop>
                            <stop
                                offset="1"
                                stopColor={
                                    mode === "dark" ? "#AE48FF" : "#C276FF"
                                }
                                stopOpacity="0"
                            ></stop>
                        </motion.linearGradient>
