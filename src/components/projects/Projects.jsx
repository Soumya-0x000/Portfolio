            ...
            {loading ? (
                ...
                >
                    ...
                    {isInView && (
                        ...
                        >
                            <div
                                className={`w-full md:w-[80%] lg:w-[70%] xl:w-[60%] px-1 py-1 md:py-2 md:px-2 flex items-center justify-between rounded-full bg-gradient-to-r ${
                                    mode === "dark"
                                        ? "from-[#e39dfff3] to-[#58b1fff2]"
                                        : "ring-[1p] from-[#ceffe7] to-[#b1d3ff] ring-violet-600"
                                } `}
                            >
                                <div
