...
const Footer = () => {
    ...
    return (
        <div className={`px-[1rem] lg:px-16 py-6 border-t  space-y-3 flex items-center justify-center ${mode === 'dark' ? 'bg-darkBlue text-light border-t-light' : 'border-t-black'}`}>
