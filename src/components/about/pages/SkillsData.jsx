...
const nextUiSvg = () => {
    return (
        <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="44" fill="#9ca3af">
...
const skillsData = [
    ...
    {id: 5, name: 'React', src: react, type: 'image', shadow: 'shadow-cyan-400', border: 'border-cyan-400'},
    ...
    {id: 18, name: 'Next UI', src: nextUiSvg, type: 'svg', shadow: 'shadow-gray-400', border: 'border-sky-400'},
];
